...
Some have criticised the book for its lack of strong, female characters (other than Paula Myo). It's true enough that most of the other major female characters are basically sleeping with a more interesting male character. I think a big problem is when female characters are only relevant by their relationship to male characters — if that makes sense. It's common enough with space opera, but considering the book was written in 2005, I might have hoped for something a little more.
